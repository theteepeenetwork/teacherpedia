            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="white-box">
                        ...
                        <form class="form-horizontal" id="uploadForm" action="/admin/resources/update_resource/<?php echo $row->id ?>" method="post" name="form" enctype="multipart/form-data">
                            <fieldset>
                                <!-- Form Name -->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="">
                                        <textarea class="form-control" id="resource_excerpt" name="resource_excerpt"> <?php echo $row->resource_excerpt ?></textarea>
                                    </div>
                                </div>
