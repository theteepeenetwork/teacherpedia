...
class CreateDeletedResources extends Migration
{
    public function up()
    {
        $this->forge->addField([
            'id'                   => ['type' => 'INT', 'constraint' => 11, 'unsigned' => true, 'auto_increment' => true],
            'old_id'               => ['type' => 'INT', 'constraint' => 11, 'null' => true],
            ...
            'deleted_date'         => ['type' => 'VARCHAR', 'constraint' => 50, 'null' => true],
            'deleted_by'           => ['type' => 'INT', 'constraint' => 11, 'null' => true],
        ]);
        $this->forge->addKey('id', true);
        $this->forge->createTable('deleted_resources', true);
    }

    public function down()
    {
        $this->forge->dropTable('deleted_resources', true);
    }
}
