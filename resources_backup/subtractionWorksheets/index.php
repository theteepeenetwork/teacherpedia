<head>
    ...
    <form class="needs-validation" id="questionsform" action="<?php echo base_url();?>resources/loadSheet/subtractionWorksheets/generator" method="post" name="form">
        <h4>Choose the maximum number of digits for the top number.<br /></h4>
        ...
        <h4>Choose the maximum number of digits for the bottom number. <br /></h4>
        <table style="width:100%">
        <tr>
