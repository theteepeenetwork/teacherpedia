    <form class="needs-validation" id="questionsform" action="<?php echo $action; ?>" method="post" name="form">
      ...
      <div id="bottomNumberTable" style="display: none">
        ...
        <table style="width:100%">
          <tr>
            <td>
              <div id="bottom1"><input type="radio" name="bottomNumber" value="1" onclick="showMissingSelect()"> 1</div>
            </td>
            <td>
              <div id="bottom2"><input type="radio" name="bottomNumber" value="2" onclick="showMissingSelect()"> 2</div>
            </td>
            <td>
              <div id="bottom3"><input type="radio" name="bottomNumber" value="3" onclick="showMissingSelect()"> 3</div>
            </td>
            <td>
              <div id="bottom4"><input type="radio" name="bottomNumber" value="4" onclick="showMissingSelect()"> 4</div>
            </td>
            <td>
              <div id="bottom5"><input type="radio" name="bottomNumber" value="5" onclick="showMissingSelect()"> 5</div>
            </td>
            <td>
              <div id="bottom6"><input type="radio" name="bottomNumber" value="6" onclick="showMissingSelect()"> 6</div>
            </td>
            <td>
              <div id="bottom7"><input type="radio" name="bottomNumber" value="7" onclick="showMissingSelect()"> 7</div>
            </td>
      ...
      <div id="missingNumber" style="display: none;">
        ...
        <input id="toHide" type="radio" name="calculation" value="subtraction" checked="checked"><br>

        <br />
        <button class="resource-form-button btn btn-lg btn-primary" type="submit">Submit</button>
      </div>
      <br />
    </form>
    </div>
