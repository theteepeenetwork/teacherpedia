        ...
        <table class="table table-bordered" border="1" width="1000" cellspacing="0" cellpadding="0">
            <tbody>
                ...
                <tr>
                    ...
                    <td width="250">
                        <p>I can compare and order fractions whose denominators are all different.</p>
                    </td>
                    <td width="47">
                ...
                <tr>
                    ...
                    <td width="250">
                        <p>I can read and write decimal numbers as equivalent fractions in their simplest form.</p>
                    </td>
                    <td width="47">
