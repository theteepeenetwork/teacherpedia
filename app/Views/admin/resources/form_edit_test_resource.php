                        ...
                        <table id="myTable" class="table table-striped">
                            ...
                            <tbody>
                                ...
                                foreach ($resources as $row) {
                                    echo
                                        '<tr>' .
                                            '<td><a href="' . base_url('admin/resources/edit_test_resource/' . $row->id) . '">' . $row->resource_author . '</a></td>' .
                                            '<td><a href="' . base_url('admin/resources/edit_test_resource/' . $row->id) . '">' . $row->resource_name . '</a></td>' .
                                            '<td>' . $row->slug . '</td>' .
