...
public
    ...
    function number_line()
        {
        $a = rand(1, 11);
        $answr = 'Mark accuracy to within 5 either way on the number line.<br /><img style="max-width: 400px;" src="' . base_url() . 'images/worksheets/images/numberlines/a' . $a . '.png">';
        $qtnstrg = 'What number is the arrow pointing to? <br /><img style="max-width: 400px;" src="' . base_url() . 'images/worksheets/images/numberlines/q' . $a . '.png">';
        return $this->make_array($qtnstrg, $answr);
        }
    ...
    function number_liney3()
        {
        $a = rand(1, 10);
        $answr = 'Mark accuracy to within 5 either way on the number line.<br /><img style="max-width: 400px;" src="' . base_url() . 'images/worksheets/images/numberlinesy3/a' . $a . '.png">';
        $qtnstrg = 'What number is the arrow pointing to? <br /><img style="max-width: 400px;" src="' . base_url() . 'images/worksheets/images/numberlinesy3/q' . $a . '.png">';
        return $this->make_array($qtnstrg, $answr);
        }
    ...
    public function decimalAsSimplestFraction() {
        ...
        $qtn = "Write " . $decimal . " as a fraction in its simlpest form.";
