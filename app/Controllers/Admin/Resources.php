...
class Resources extends Admin_Controller
{
    ...
    function do_uploads($page = "")
    {
        ...
        //$config['upload_path']   = $dirLoc;   //CI3
        //$config['allowed_types'] = '*';       //CI3
        //$config['remove_spaces'] = TRUE;      //CI3

        //$this->load->library('upload', $config); //CI3
        //$this->upload->initialize($config);   //CI3
